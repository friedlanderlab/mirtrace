...
## Requirements
* Java 1.7 or higher. We recommend using OpenJDK or any other open source-licensed JDK. Example: [JDK 11.0.1 General-Availability Release](https://jdk.java.net/11/)
